...
$$dX=\begin{aligned} dx_{11} & \cdots & dx_{1n} \\ \vdots & \vdots & \vdots \\ dx_{m1} & \cdots & dx_{mn} \end{aligned}$$
...
\\&= tr(\begin{bmatrix}\frac  {\partial f} {\partial x_{11}} & \frac  {\partial f} {\partial x_{21}} & \cdots & \frac  {\partial f} {\partial x_{m1}} \\ \vdots & \vdots & \vdots & \vdots \\ \frac  {\partial f} {\partial x_{1n}} & \frac  {\partial f} {\partial x_{2n}} & \cdots & \frac  {\partial f} {\partial x_{mn}}\end{bmatrix}_{n \times m}  \begin{bmatrix}dx_{11} & dx_{12} & \cdots & dx_{1n} \\ \vdots & \vdots & \vdots & \vdots \\ dx_{m1} & dx_{m2} & \cdots & dx_{mn} \end{bmatrix}_{m \times n})
